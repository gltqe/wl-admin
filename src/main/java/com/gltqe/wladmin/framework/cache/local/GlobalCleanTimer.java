...
public class GlobalCleanTimer {
     ...
     * 单例实例
     */
    private static GlobalCleanTimer INSTANCE;
     ...
     * 获取单例实例
     */
    public static GlobalCleanTimer getInstance() {
        if (INSTANCE == null) {
            synchronized (GlobalCleanTimer.class) {
                if (INSTANCE == null) {
                    INSTANCE = new GlobalCleanTimer();
                }
            }
        }
        return INSTANCE;
